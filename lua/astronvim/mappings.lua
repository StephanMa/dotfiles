...
if is_available "telescope.nvim" then
  ...
  maps.n["gd"] = {function() require("telescope.builtin").lsp_definitions() end , desc="Go to the definitions of the current symbol"}
  maps.n["gr"] = {function() require("telescope.builtin").lsp_references() end , desc="Find references to the current symbol"}
  maps.n["<leader>l"] = sections.l
  maps.n["<leader>ls"] = {
    function()
